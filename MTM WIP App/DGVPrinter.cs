...
namespace MTM_WIP_App //AllocationRequest
{
    ...
    public class DgvPrinter
    {
        ...
        public class ImbeddedImage
        {
            ...
            internal Point Upperleft(int pagewidth, int pageheight, Margins margins)
            {
                ...
                var x = ImageAlignment switch
                {
                    ...
                    Alignment.Center => (int)(pagewidth / 2 - TheImage.Width / 2) + margins.Left,
                    Alignment.Right => (int)(pagewidth - TheImage.Width) + margins.Left,
        ...
        // print status items
        private bool _embeddedPrinting = false;
        ...
        private float _staticheight = 0;
        private float _rowstartlocation = 0;
        private int _pageWidth = 0;
        private int _printWidth = 0;
        private float _rowheaderwidth = 0;
        ...
        private float _pagenumberHeight = 0;

        private float _colheaderheight = 0;
        ...
        public bool EnableLogging
        {
            ...
            set
            {
                ...
                if (Enablelogging)
                {
                    _logger = new LogManager(".", "DGVPrinter");
                }
            }
        }
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        /// </summary>
        public PrinterSettings PrintSettings => _printDoc.PrinterSettings;

        /// <summary>
        /// expose settings for the PrintDialog displayed to the user
        /// </summary>
        private readonly PrintDialogSettingsClass _printDialogSettings = new();

        public PrintDialogSettingsClass PrintDialogSettings => _printDialogSettings;
        ...
        /// </summary>
        private PrintPreviewDialog _previewdialog = null;

        public PrintPreviewDialog PreviewDialog
        {
            get => _previewdialog;
            set => _previewdialog = value;
        }
...
#pragma warning restore CS8629 // Nullable value type may be null.
        ...
        /// </summary>
        private bool? _printColumnHeaders;

        public bool? PrintColumnHeaders
        {
            get => _printColumnHeaders;
        ...
        /// </summary>
        private bool? _printRowHeaders = false;

        public bool? PrintRowHeaders
        {
            get => _printRowHeaders;
        ...
        /// </summary>
        private bool _keepRowsTogether = true;

        public bool KeepRowsTogether
        {
            get => _keepRowsTogether;
            set => _keepRowsTogether = value;
        }
        ...
        /// </summary>
        private float _keeprowstogethertolerance = 15;

        public float KeepRowsTogetherTolerance
        {
            get => _keeprowstogethertolerance;
            set => _keeprowstogethertolerance = value;
        }
        ...
        // override flag
        private bool _overridetitleformat = false;
        ...
        /// </summary>
        private PrintLocation _titleprint = PrintLocation.All;

        public PrintLocation TitlePrint
        {
            get => _titleprint;
            set => _titleprint = value;
        }
        ...
        private float TitleHeight
        {
            get
            {
                ...
                {
                    return _titleheight + _titlespacing;
                }

                if (PrintLocation.FirstOnly == TitlePrint && 1 == _currentPage)
                {
                    return _titleheight + _titlespacing;
                }
        ...
        /// </summary>
        private float _titlespacing;

        public float TitleSpacing
        {
            get => _titlespacing;
            set => _titlespacing = value;
        }
        ...
        public Brush TitleBackground
        {
            ...
            set => _titlebackground = value;
        }

        /// <summary>
        /// Title Block Border
        /// </summary>
        private Pen _titleborder;

        public Pen TitleBorder
        {
            get => _titleborder;
            set => _titleborder = value;
        }
        ...
        // override flat
        private bool _overridesubtitleformat = false;

        // formatted height of subtitle
        private float _subtitleheight = 0;
        ...
        /// Control where in the document the title prints
        /// </summary>
        private PrintLocation _subtitleprint = PrintLocation.All;

        public PrintLocation SubTitlePrint
        {
            get => _subtitleprint;
            set => _subtitleprint = value;
        }
        ...
        private float SubTitleHeight
        {
            get
            {
                ...
                {
                    return _subtitleheight + _subtitlespacing;
                }
        ...
        /// Mandatory spacing between the grid and the footer
        /// </summary>
        private float _subtitlespacing;

        public float SubTitleSpacing
        {
            get => _subtitlespacing;
        ...
        /// Title Block Background Color
        /// </summary>
        private Brush _subtitlebackground;

        public Brush SubTitleBackground
        {
            get => _subtitlebackground;
            set => _subtitlebackground = value;
        }

        /// <summary>
        /// Title Block Border
        /// </summary>
        private Pen _subtitleborder;

        public Pen SubTitleBorder
        {
            get => _subtitleborder;
            set => _subtitleborder = value;
        }
        ...
        // override flag
        private bool _overridefooterformat = false;
        ...
        /// Mandatory spacing between the grid and the footer
        /// </summary>
        private float _footerspacing;

        public float FooterSpacing
        {
            get => _footerspacing;
            set => _footerspacing = value;
        }

        /// <summary>
        /// Control where in the document the title prints
        /// </summary>
        private PrintLocation _footerprint = PrintLocation.All;

        public PrintLocation FooterPrint
        {
            get => _footerprint;
            set => _footerprint = value;
        }
        ...
        public Brush FooterBackground
        {
            ...
            set => _footerbackground = value;
        }

        /// <summary>
        /// Title Block Border
        /// </summary>
        private Pen _footerborder;

        public Pen FooterBorder
        {
            get => _footerborder;
            set => _footerborder = value;
        }
        ...
        // override flag
        private bool _overridepagenumberformat = false;

        /// <summary>
        /// Include page number in the printout. Default is true.
        /// </summary>
        private bool _pageno = true;
        ...
        /// </summary>
        private bool _pagenumberontop = false;

        public bool PageNumberInHeader
        {
            get => _pagenumberontop;
            set => _pagenumberontop = value;
        }
        ...
        /// </summary>
        private bool _pagenumberonseparateline = false;

        public bool PageNumberOnSeparateLine
        {
            get => _pagenumberonseparateline;
            set => _pagenumberonseparateline = value;
        }

        /// <summary>
        /// Show the total page number as n of total 
        /// </summary>
        private bool _showtotalpagenumber = false;

        public bool ShowTotalPageNumber
        {
            get => _showtotalpagenumber;
            set => _showtotalpagenumber = value;
        }

        /// <summary>
        /// Text separating page number and total page number. Default is ' of '.
        /// </summary>
        private string _pageseparator = " of ";

        public string PageSeparator
        {
            get => _pageseparator;
            set => _pageseparator = value;
        }
        ...
        /// Control where in the document the title prints
        /// </summary>
        private PrintLocation _pagenumberprint = PrintLocation.All;

        public PrintLocation PageNumberPrint
        {
            get => _pagenumberprint;
            set => _pagenumberprint = value;
        }
        ...
        private float PageNumberHeight
        {
            get
            {
                    ...
                    || (PrintLocation.LastOnly == PageNumberPrint && _totalpages == _currentPage))
                {
                    ...
                    if (_pagenumberonseparateline)
                    {
                        return _pagenumberHeight;
                    }
                    else if (_pagenumberontop && 0 == TitleHeight && 0 == SubTitleHeight)
                    {
                        return _pagenumberHeight;
                    }
                    else if (!_pagenumberontop && 0 == FooterHeight)
                    {
                        return _footerspacing + _pagenumberHeight;
                    }
                }
        ...
        private DataGridViewCellStyle _rowheaderstyle;

        public DataGridViewCellStyle RowHeaderCellStyle
        {
            get => _rowheaderstyle;
            set => _rowheaderstyle = value;
        }

        /// <summary>
        /// Allow override of the row header cell format object
        /// </summary>
        private StringFormat _rowheadercellformat = null;
        ...
        public StringFormat GetRowHeaderCellFormat(DataGridView grid)
        {
            ...
            if (null != grid && null == _rowheadercellformat)
            {
                Buildstringformat(ref _rowheadercellformat, grid.Rows[0].HeaderCell.InheritedStyle,
                    _headercellalignment, StringAlignment.Near, _headercellformatflags,
                    StringTrimming.Word);
            }
            ...
            {
                _rowheadercellformat = new StringFormat(_headercellformatflags);
            }
        ...
        /// </summary>
        private string _rowheadercelldefaulttext = "\t";

        public string RowHeaderCellDefaultText
        {
            get => _rowheadercelldefaulttext;
            set => _rowheadercelldefaulttext = value;
        }

        /// <summary>
        /// Allow override of the header cell format object
        /// </summary>
        private readonly Dictionary<string, DataGridViewCellStyle> _columnheaderstyles =
            new();

        public Dictionary<string, DataGridViewCellStyle> ColumnHeaderStyles => _columnheaderstyles;

        /// <summary>
        /// Allow override of the header cell format object
        /// </summary>
        private StringFormat _columnheadercellformat = null;
        ...
        public StringFormat GetColumnHeaderCellFormat(DataGridView grid)
        {
            ...
            {
                _columnheadercellformat = new StringFormat(_headercellformatflags);
            }
        ...
        /// Alignment - Near; 
        /// </summary>
        private StringAlignment _headercellalignment;

        public StringAlignment HeaderCellAlignment
        {
            get => _headercellalignment;
            set => _headercellalignment = value;
        }
        ...
        /// are: FormatFlags - NoWrap, LineLimit, NoClip
        /// </summary>
        private StringFormatFlags _headercellformatflags;

        public StringFormatFlags HeaderCellFormatFlags
        {
            get => _headercellformatflags;
            set => _headercellformatflags = value;
        }
        ...
        private readonly Dictionary<string, float> _publicwidthoverrides = new();
        public Dictionary<string, float> ColumnWidths => _publicwidthoverrides;

        /// <summary>
        /// Allow per column style overrides
        /// </summary>
        private readonly Dictionary<string, DataGridViewCellStyle> _colstyles =
            new();

        public Dictionary<string, DataGridViewCellStyle> ColumnStyles => _colstyles;

        /// <summary>
        /// Allow per column style overrides
        /// </summary>
        private readonly Dictionary<string, DataGridViewCellStyle> _altrowcolstyles =
            new();

        public Dictionary<string, DataGridViewCellStyle> AlternatingRowColumnStyles => _altrowcolstyles;
        ...
        private readonly List<string> _fixedcolumnnames = [];
        public List<string> FixedColumns => _fixedcolumnnames;

        /// <summary>
        /// List of columns to not display in the grid view printout.
        /// </summary>
        private readonly List<string> _hidecolumns = [];

        public List<string> HideColumns => _hidecolumns;
        ...
        private string _breakonvaluechange;

        public string BreakOnValueChange
        {
            get => _breakonvaluechange;
            set => _breakonvaluechange = value;
        }
        ...
        /// </summary>
        public PageSettings PageSettings => _printDoc.DefaultPageSettings;
        ...
        {
            double displayWidth = _printDoc.DefaultPageSettings.Bounds.Width
                                  + 3 * _printDoc.DefaultPageSettings.HardMarginY;
        ...
        {
            double displayHeight = _printDoc.DefaultPageSettings.Bounds.Height
                                   + 3 * _printDoc.DefaultPageSettings.HardMarginX;
        ...
        public DgvPrinter()
        {
            ...
            // set default fonts
            _pagenofont = new Font("Tahoma", 8, FontStyle.Regular, GraphicsUnit.Point);
            _pagenocolor = Color.Black;
            _titlefont = new Font("Tahoma", 18, FontStyle.Bold, GraphicsUnit.Point);
            _titlecolor = Color.Black;
            _subtitlefont = new Font("Tahoma", 12, FontStyle.Bold, GraphicsUnit.Point);
            _subtitlecolor = Color.Black;
            _footerfont = new Font("Tahoma", 10, FontStyle.Bold, GraphicsUnit.Point);
            _footercolor = Color.Black;
            ...
            _headercellalignment = StringAlignment.Near;
            _headercellformatflags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip;
        ...
        public void PrintDataGridView(DataGridView dgv)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("PrintDataGridView process started");
            }
        ...
        public void PrintPreviewDataGridView(DataGridView dgv)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("PrintPreviewDataGridView process started");
            }
        ...
        public DialogResult DisplayPrintDialog()
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("DisplayPrintDialog process started");
            }

            // create new print dialog and set options
            PrintDialog pd = new()
            {
                UseEXDialog = _printDialogSettings.UseExDialog,
                AllowSelection = _printDialogSettings.AllowSelection,
                AllowSomePages = _printDialogSettings.AllowSomePages,
                AllowCurrentPage = _printDialogSettings.AllowCurrentPage,
                AllowPrintToFile = _printDialogSettings.AllowPrintToFile,
                ShowHelp = _printDialogSettings.ShowHelp,
                ShowNetwork = _printDialogSettings.ShowNetwork,
            ...
            {
                _printDoc.PrinterSettings.PrinterName = _printerName;
            }
        ...
        public void PrintNoDisplay(DataGridView dgv)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("PrintNoDisplay process started");
            }
            ...
            _printDoc.BeginPrint += BeginPrintEventHandler;
        ...
        public void PrintPreviewNoDisplay(DataGridView dgv)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("PrintPreviewNoDisplay process started");
            }
            ...
            _printDoc.PrintPage += new PrintPageEventHandler(PrintPageEventHandler);
            _printDoc.BeginPrint += new PrintEventHandler(BeginPrintEventHandler);
        ...
        public bool EmbeddedPrint(DataGridView dgv, Graphics g, Rectangle area)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("EmbeddedPrint process started");
            }
        ...
        public void EmbeddedPrintMultipageSetup(DataGridView dgv, Rectangle area)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("EmbeddedPrintMultipageSetup process started");
            }
        ...
        public void BeginPrintEventHandler(object sender, PrintEventArgs e)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("BeginPrintEventHandler called. Printing started.");
            }
        ...
        public void PrintPageEventHandler(object sender, PrintPageEventArgs e)
        {
            if (EnableLogging)
            {
                _logger.LogInfoMsg("PrintPageEventHandler called. Printing a page.");
            }
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        private void SetupPrint()
        {
            if (EnableLogging)
            {
                ...
                var m = _printDoc.DefaultPageSettings.Margins;
            ...
            {
                PrintColumnHeaders = _dgv.ColumnHeadersVisible;
            }

            if (null == PrintRowHeaders)
            {
                PrintRowHeaders = _dgv.RowHeadersVisible;
            }
...
#pragma warning restore CS8604 // Possible null reference argument.
            ...
            {
                int printareawidth;
                var hardx = (int)Math.Round(_printDoc.DefaultPageSettings.HardMarginX);
                var hardy = (int)Math.Round(_printDoc.DefaultPageSettings.HardMarginY);
                ...
                _pageHeight = _printDoc.DefaultPageSettings.Bounds.Height;
                _pageWidth = _printDoc.DefaultPageSettings.Bounds.Width;
            ...
            // save print range 
            _printRange = _printDoc.PrinterSettings.PrintRange;
            if (EnableLogging)
            {
                _logger.LogInfoMsg(string.Format("PrintRange is {0}", _printRange));
            }
            ...
            if (PrintRange.SomePages == _printRange)
            {
                ...
                _fromPage = _printDoc.PrinterSettings.FromPage;
                _toPage = _printDoc.PrinterSettings.ToPage;
            }
            else
            {
            ...
            Measureprintarea(_printDoc.PrinterSettings.CreateMeasurementGraphics());
        ...
        private void SetupColumns()
        {
            ...
            foreach (var colname in _fixedcolumnnames)
            {
                try
                {
            ...
            foreach (DataGridViewColumn col in _colstoprint)
            {
                if (_publicwidthoverrides.ContainsKey(col.Name))
                {
                    _colwidthsoverride.Add(_publicwidthoverrides[col.Name]);
                }
                else
                {
        ...
        private void SetupPrintRange()
        {
            ...
            foreach (var item in temprowstoprint.Values)
            {
                _rowstoprint.Add(new Rowdata() { Row = (DataGridViewRow)item });
            }

            _colstoprint = new List<DataGridViewColumn>(tempcolstoprint.Count);
            foreach (var item in tempcolstoprint.Values)
            {
                _colstoprint.Add(item);
            }

            // remove "hidden" columns from list of columns to print
            foreach (var columnname in HideColumns)
            {
                _colstoprint.Remove(_dgv.Columns[columnname]);
            }

            if (EnableLogging)
            {
                _logger.LogInfoMsg(string.Format("Grid Printout Range is {0} columns", _colstoprint.Count));
            }

            if (EnableLogging)
            {
                _logger.LogInfoMsg(string.Format("Grid Printout Range is {0} rows", _rowstoprint.Count));
            }
        }
            ...
            StringTrimming trim)
        {
            ...
            if (null != controlstyle)
            {
                ...
                else if (cellalign.ToString().Contains("Bottom"))
                {
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        private void Measureprintarea(Graphics g)
        {
            ...
            for (i = 0; i < _colstoprint.Count; i++)
            {
                ...
                if (ColumnHeaderStyles.ContainsKey(col.Name))
                {
                    headercolstyle = _columnheaderstyles[col.Name];
            ...
            if (_pageno)
            {
                _pagenumberHeight = g.MeasureString("Page", _pagenofont, _printWidth, _pagenumberformat).Height;
            }
            ...
            if (PrintHeader)
            {
                ...
                _titleheight = g.MeasureString(_title, _titlefont, _printWidth, _titleformat).Height;
                _subtitleheight = g.MeasureString(_subtitle, _subtitlefont, _printWidth, _subtitleformat).Height;
            }
            ...
            if (PrintFooter)
            {
                ...
                {
                    _footerHeight += g.MeasureString(_footer, _footerfont, _printWidth, _footerformat).Height;
                }

                _footerHeight += _footerspacing;
            }
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        private void AdjustPageSets(Graphics g, PageDef pageset)
        {
            ...
            if ((_porportionalcolumns || ColumnWidthSetting.Porportional == ColumnWidth) &&
                0 < remainingcolwidth)
            {
                ratio = ((float)_printWidth - fixedcolwidth) / (float)remainingcolwidth;
            }
            else
            {
                ratio = (float)1.0;
        ...
        private int Pagination()
        {
            ...
            if (!string.IsNullOrEmpty(_breakonvaluechange))
            {
                _oldvalue = _rowstoprint[0].Row.Cells[_breakonvaluechange].EditedFormattedValue;
            }
            ...
            for (var currentrow = 0; currentrow < _rowstoprint.Count; currentrow++)
            {
                ...
                if (pos + _rowstoprint[currentrow].Height >= _staticheight)
                {
                ...
                if (!string.IsNullOrEmpty(_breakonvaluechange) &&
                    !_oldvalue.Equals(_rowstoprint[currentrow].Row.Cells[_breakonvaluechange].EditedFormattedValue))
                {
                    newpage = Paging.Datachange;
                    _oldvalue = _rowstoprint[currentrow].Row.Cells[_breakonvaluechange].EditedFormattedValue;
                }
        ...
        private bool PrintPage(Graphics g)
        {
            ...
            while (!printthispage)
            {
                ...
                do
                {
                    ...
                    if (0 == _rowstartlocation && _lastrowprinted >= _rowstoprint.Count - 1)
                    {
                        pagecomplete = true;
                    }
                } while (!pagecomplete);
            ...
            if (PrintHeader)
            {
                ...
                {
                    Printsection(g, ref printpos, _title, _titlefont,
                        _titlecolor, _titleformat, _overridetitleformat,
                        _pagesets[_currentpageset],
                        _titlebackground, _titleborder);
                }
                ...
                if (0 != SubTitleHeight && !string.IsNullOrEmpty(_subtitle))
                {
                    Printsection(g, ref printpos, _subtitle, _subtitlefont,
                        _subtitlecolor, _subtitleformat, _overridesubtitleformat,
                        _pagesets[_currentpageset],
                        _subtitlebackground, _subtitleborder);
                }
...
#pragma warning restore CS8629 // Nullable value type may be null.
            ...
            if (PrintFooter)
            {
                ...
                if (0 != FooterHeight)
                {
                    Printfooter(g, ref printpos, _pagesets[_currentpageset]);
                }
            }
        ...
        private float PrintPageNo(Graphics g, float printpos)
        {
            if (_pageno)
            {
                var pagenumber = _pagetext + _currentPage.ToString(CultureInfo.CurrentCulture);
                if (_showtotalpagenumber)
                {
                    pagenumber += _pageseparator + _totalpages.ToString(CultureInfo.CurrentCulture);
                }

                if (1 < _pagesets.Count)
                {
                    pagenumber += _parttext + (_currentpageset + 1).ToString(CultureInfo.CurrentCulture);
                }

                // ... then print it
                Printsection(g, ref printpos,
                    pagenumber, _pagenofont, _pagenocolor, _pagenumberformat,
        ...
        {
            // print the footer
            Printsection(g, ref pos, _footer, _footerfont, _footercolor, _footerformat,
                _overridefooterformat, pageset, _footerbackground, _footerborder);
        }
